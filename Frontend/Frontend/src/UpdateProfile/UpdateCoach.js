...
const UpdateCoach = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put('http://localhost:8080/api/coach/update', updatedFormData, {
        headers: {
  ...
  return (
    ...
    <h2 style={headingStyle}>Update Coach Profile</h2>
    <form onSubmit={handleSubmit} style={formStyle}>
      ...
      <button type="submit" style={buttonStyle}>Update Coach</button>
    </form>
  </div>  
  );
};
